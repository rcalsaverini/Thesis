...
\begin{epigraphs}
 \qitem{The resemblance between humans and chimpanzees is not only external. If we look straight and deep into a chimpanzee's eyes, an intelligent self-assured personality looks back at us. If they are animals, what must we be?}
 {\---- \textsc{``Chimpanzee Politics: Power and Sex among Apes'' de Frans de Waal\citep{deWaal2007}}}
 \\[2ex]
 \qitem{There isn’t a sharp line dividing humans from the rest of the animal kingdom --- it’s a very wuzzy line --- it’s a very wuzzy line --- and it’s getting wuzzy-er all the time﻿...}
...
\begin{fullwidth}
\begin{figure}
	\includegraphics[width =2.0\textwidth, angle=90]{figuras/phasediagram.png}
