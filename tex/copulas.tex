\chapter{Dependência Estatística, Teoria de Cópulas e Teoria de Informação}
...
\end{equation}
Ou seja: as distribuições $\phi_j(x_j)$ devem ser as distribuição marginais da variáveis $X_j$, e podemos reescrever:
\begin{equation}
\label{eq:infomutua2}
...
H(X_1, X_2, \ldots, X_N) = \sum_{i=1}^{N} H(X_i) + S[c] 
\end{equation}
...
\begin{figure}
 ...
 \subfloat[Seleção de pares compatíveis com uma distribuição gaussiana.]{\includegraphics[width = \textwidth]{./figuras/gausscompat.pdf}}
